...
PUBLIC void task_init(){
    // proc_init_a_task(TASK_INIT, "init", TASK_INIT, (void*)task_init_init, 1);
    proc_init_a_task(TASK_SYS, "sys_call", TASK_SYS, (void*)task_sys_call, 1);
    proc_init_a_task(TASK_MM, "mm", TASK_MM, (void*)task_mm, 1);
}
